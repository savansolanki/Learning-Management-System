...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="text" id="email"  name="email" class="email" maxlength="256" name="email" value="{{ old('email') }}"
               required autofocus/>
    ...
    <button type="submit" class="btn btn-primary"> Login <i class="fa fa-fw fa-unlock-alt"></i>
    </button>
    <br>
...
<script src="{{ asset('js/index.js') }}" class="pull-right"></script>
</body>
</html>
