                ...
                <div class="col-md-9">
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                        ...
                        <ul class="nav nav-tabs" tabindex="0" style="overflow: hidden; outline: none;">
                            <li class="active"><a href="{{ route('tutor.course.edit',$course->slug ) }}" data-toggle="tab" aria-expanded="true"><i
                        ...
                        <div class="tab-content">
                            <div id="course" class="tab-pane active">
                                <div id="course" class="tab-pane active">
                                    <form enctype="multipart/form-data"  action="{{ route('tutor.course.update',$course->slug) }}" method="POST">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }} ">
                                            ...
                                            <textarea name="description" id="description" cols="30" rows="6"
                                                      class="summernote">{{ $course->description }}"</textarea>
                                        ...
                                        <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                                            ...
                                            <select class="form-control" id="level" name="level" required autofocus>
                                                ...
                                                <option value="beginner"
                                                        @if($course->level == 'beginner') selected @endif >Beginner
                                                    Level
                                                </option>
                                                ...
                                                <option value="all" @if($course->level == 'all') selected @endif >All
                                                    Level
                                                </option>
                                            </select>
                                            @if ($errors->has('level'))
