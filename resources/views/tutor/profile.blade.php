                ...
                <div class="col-md-9">
                    ...
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                        ...
                        <div class="tab-content">
                            <div>
                                <form class="form-horizontal" enctype="multipart/form-data" action="/tutor/update"
                                      method="POST">
                                ...
                                <form class="form-horizontal" action="/tutor/profile" method="POST">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control form-group col-sm-2"
                                                       name="headline"
                                                       value="{{ $user->tutor_profile ? $user->tutor_profile->headline : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <textarea class="form-group form-control" name="biography"
                                                          ...
                                                          rows="5">{{ $user->tutor_profile ? $user->tutor_profile->biography : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="url" class="form-control" name="web" placeholder="Website"
                                                           aria-describedby="basic-addon1" value="{{ $user->tutor_profile ? $user->tutor_profile->web : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="google" placeholder="Google+ Link"
                                                           aria-describedby="basic-addon1" value="{{ $user->tutor_profile ? $user->tutor_profile->google : '' }}">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="linkedin" placeholder="LinkedIn Profile"
                                                           aria-describedby="basic-addon1" value="{{ $user->tutor_profile ? $user->tutor_profile->linkedin : '' }}">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " name="youtube" placeholder="Youtube Profile"
                                                           aria-describedby="basic-addon1" value="{{ $user->tutor_profile ? $user->tutor_profile->youtube : '' }}">
                                                </div>
                    ...
                    <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
                        ...
                        <div class="panel-body list-group">
                            <ul class="list-group list-group-menu">
                                ...
                                <li class="list-group-item active"><a class="link-text-color" href="{{ route('tutor.profile')}}">Profile</a></li>
